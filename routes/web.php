...
Route::get('certificate/student/request/{id}','Admin\certificate\CertificateController@certificateApprove')->name('certificate_approve');

Route::get('certificate/student/request/','Admin\certificate\CertificateController@certRequest')->name('certificate_stud_req');
Route::put('certificate/student/approve/','Admin\certificate\CertificateController@certRequestApprove')->name('certificate_req_approve');
