...
{{-- =================================== --}}
  {{-- START INSERT MODEL BOX --}}
      ...
      <div class="container">
        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#addGrade">Add Nationality</button>
        <!-- Modal -->
            ...
            <div class="row">
              <div style="width: 131%;" class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="col-md-12">
                    <div class="tile">
                      <h3 class="tile-title">Add Nationality</h3>
                      <div class="tile-body">
                      {{-- INSERT FORM --}}
                        <form class="row" action="{{route('nationality_add')}}" method="post">
                       @csrf
                ...
                <div class="tile-body">
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="sampleTable">
                      ...
                      @php $i=1; @endphp
                      {{-- Foreach Loop start --}}
                      @foreach($stdstdNationalities as $data)
                              ...
                              <div class="row">
                                <div style="width: 131%;" class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="col-md-12">
                                      <div class="tile">
                                        <h3 class="tile-title">Update Nationality</h3>
                                        <div class="tile-body">
                                        {{-- Update FORM --}}
                               
                                          <form class="row" action="{{route('nationality_update',$data->id)}}" method="post">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-group col-md-6" >
                                              <label for="nationality_name">Nationality Name</label>
                                                <input type="text" name="nationality_name" id="nationality_name" class="form-control" value="{{$data->nationality_name}}">
                                                @error('nationality_name')
                                                  <span class="text-danger" role="alert">
                                                  <strong>{{ $message }}</strong>
                                                </span>
