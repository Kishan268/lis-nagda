...
{{-- =================================== --}}
  {{-- START INSERT MODEL BOX --}}
      ...
      <div class="container">
        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#addGrade">Add City</button>
        <!-- Modal -->
                ...
                <div class="modal-body">
                  ...
                  <div class="col-md-12">
                    <div class="tile">
                      ...
                      <div class="tile-body">
                      {{-- INSERT FORM --}}
                        <form class="row" action="{{route('city_add')}}" method="post">
                       @csrf
                          <div class="form-group col-md-6" >
                           ...
                           <div class="form-group col-md-6" >
                              <label for="state_name"> State Name</label>
                                {{-- <input type="text" name="state_id" id="state_name" class="form-control" > --}}
                                <select class="form-control" name="state_id">

                                  <option value="">Select State</option>
                                  @foreach($state as $data1)
                                  <option value="{{$data1->id}}">{{$data1->state_name}}</option>
                                  @endforeach
                                </select>
                                @error('state_name')
                                  <span class="text-danger" role="alert">
                              ...
                              <div class="row">
                                <div style="width: 131%;" class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="col-md-12">
                                      <div class="tile">
                                        <h3 class="tile-title">Update City</h3>
                                        <div class="tile-body">
                                        {{-- Update FORM --}}
                               
                                          <form class="row" action="{{route('city_update',$data->id)}}" method="post">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-group col-md-6" >
                                              <label for="city_name">City Name</label>
                                                <input type="text" name="city_name" id="city_name" class="form-control" value="{{$data->city_name}}">
                                                @error('state_name')
                                                  <span class="text-danger" role="alert">
                                                  <strong>{{ $message }}</strong>
                                                </span>
                                             ...
                                             <div class="form-group col-md-6" >
                                              <label for="state_name">State name</label>
                                               {{--  <input type="text" name="state_id" id="state_name" class="form-control" value="{{$data->state_id}}"> --}}
                                                <select class="form-control" name="state_id">
