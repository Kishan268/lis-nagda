...
{{-- =================================== --}}
  {{-- START INSERT MODEL BOX --}}
      ...
      <div class="container">
        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#addGrade">Add Professtion Types</button>
        <!-- Modal -->
            ...
            <div class="row">
              <div style="width: 131%;" class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="col-md-12">
                    <div class="tile">
                      <h3 class="tile-title">Add Professtion</h3>
                      <div class="tile-body">
                      {{-- INSERT FORM --}}
                        <form class="row" action="{{route('professtiontype_add')}}" method="post">
                       @csrf
                          <div class="form-group col-md-6" >
                              <label for="professtion_types_name"> Professtion Type Name</label>
                                <input type="text" name="professtion_types_name" id="professtion_types_name" class="form-control" >
                                @error('professtion_types_name')
                ...
                <div class="tile-body">
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="sampleTable">
                      ...
                      @php $i=1; @endphp
                      {{-- Foreach Loop start --}}
                      @foreach($professtionType as $data)
                    
                        <tr>
                          <td>{{ $i++}}</td>
                          <td>{{ $data->professtion_types_name}}</td>
                              ...
                              <div class="row">
                                <div style="width: 131%;" class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="col-md-12">
                                      <div class="tile">
                                        <h3 class="tile-title">Update Professtion Types Name</h3>
                                        <div class="tile-body">
                                        {{-- Update FORM --}}
                               
                                          <form class="row" action="{{route('professtiontype_update',$data->id)}}" method="post">
                                            @csrf
                                            @method('PUT')
                                 
                                          
                                            <div class="form-group col-md-6" >
                                              <label for="professtion_types_name">Professtion Types Name</label>
                                                <input type="text" name="professtion_types_name" id="professtion_types_name" class="form-control" value="{{$data->professtion_types_name}}">
                                                @error('professtion_types_name')
                                                  <span class="text-danger" role="alert">
                                                  <strong>{{ $message }}</strong>
                                                </span>
