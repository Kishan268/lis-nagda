                  ...
                  <div class="col-md-12">
                     ...
                     <div class="col-md-4">
                        <label class="red"> *</label>
                         ...
                         <select name="discount_no_type" class="form-control" >
                           ...
                           <option value="F" {{(old('discount_no_type') ?? $edit->discount_no_type) == 'F' ? 'selected':'' }}>First</option>
                           <option value="S" {{(old('discount_no_type') ?? $edit->discount_no_type) =='S' ? 'selected':'' }}>Second</option>
                           <option value="T" {{(old('discount_no_type') ?? $edit->discount_no_type) =='T' ? 'selected':'' }}>Third</option>
                         </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="discount_amount">Discount Amount</label>
                         <input type="text" name="discount_amount" class="form-control " value="{{(int)$edit->discount_amount}}"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
