...
{{-- =================================== --}}
  {{-- START INSERT MODEL BOX --}}
      ...
      <div class="container">
        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#addGrade">Add Mothetongue</button>
        <!-- Modal -->
            ...
            <div class="row">
              <div style="width: 131%;" class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="col-md-12">
                    <div class="tile">
                      <h3 class="tile-title">Add Mothetongue</h3>
                      <div class="tile-body">
                      {{-- INSERT FORM --}}
                        <form class="row" action="{{route('mothetongue_add')}}" method="post">
                       @csrf
                          <div class="form-group col-md-6" >
                              <label for="mothetongue_name"> Mothetongue Name</label>
                                <input type="text" name="mothetongue_name" id="mothetongue_name" class="form-control" >
                                @error('mothetongue_name')
                ...
                <div class="tile-body">
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="sampleTable">
                      ...
                      @php $i=1; @endphp
                      {{-- Foreach Loop start --}}
                      @foreach($stdMothetongue as $data)
                    
                        <tr>
                          <td>{{ $i++}}</td>
                          <td>{{ $data->mothetongue_name}}</td>
                              ...
                              <div class="row">
                                <div style="width: 131%;" class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="col-md-12">
                                      <div class="tile">
                                        <h3 class="tile-title">Update Mothetongue</h3>
                                        <div class="tile-body">
                                        {{-- Update FORM --}}
                               
                                          <form class="row" action="{{route('mothetongue_update',$data->id)}}" method="post">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-group col-md-6" >
                                              <label for="mothetongue_name">Mothetongue Name</label>
                                                <input type="text" name="mothetongue_name" id="mothetongue_name" class="form-control" value="{{$data->mothetongue_name}}">
                                                @error('mothetongue_name')
                                                  <span class="text-danger" role="alert">
                                                  <strong>{{ $message }}</strong>
                                                </span>
