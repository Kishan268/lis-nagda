...
{{-- =================================== --}}
  {{-- START INSERT MODEL BOX --}}
      ...
      <div class="container">
        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#addGrade">Add Guardian Designations</button>
        <!-- Modal -->
            ...
            <div class="row">
              <div style="width: 131%;" class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="col-md-12">
                    <div class="tile">
                      <h3 class="tile-title">Add Guardian Designations</h3>
                      <div class="tile-body">
                      {{-- INSERT FORM --}}
                        <form class="row" action="{{route('gaurdian_designation_add')}}" method="post">
                       @csrf
                          <div class="form-group col-md-6" >
                              <label for="guardian_designations_name"> Guardian Designations Name</label>
                                <input type="text" name="guardian_designations_name" id="guardian_designations_name" class="form-control" >
                                @error('guardian_designations_name')
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="sampleTable">
                      <thead>
                        <tr>
                          <th>S.No</th>
                          <th>Guardian Designations Name</th>
                          <th>Action</th>
                        </tr>
                      </thead>
                      <tbody>
                      @php $i=1; @endphp
                      {{-- Foreach Loop start --}}
                      @foreach($gaurdianDesignation as $data)
                    
                        <tr>
                          <td>{{ $i++}}</td>
                          <td>{{ $data->guardian_designations_name}}</td>
                              ...
                              <div class="row">
                                <div style="width: 131%;" class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="col-md-12">
                                      <div class="tile">
                                        <h3 class="tile-title">Update Guardian Designations</h3>
                                        <div class="tile-body">
                                        {{-- Update FORM --}}
                               
                                          <form class="row" action="{{route('gaurdian_designation_update',$data->id)}}" method="post">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-group col-md-6" >
                                              <label for="guardian_designations_name">Guardian Designations Name</label>
                                                <input type="text" name="guardian_designations_name" id="guardian_designations_name" class="form-control" value="{{$data->guardian_designations_name}}">
                                                @error('guardian_designations_name')
                                                  <span class="text-danger" role="alert">
                                                  <strong>{{ $message }}</strong>
                                                </span>
