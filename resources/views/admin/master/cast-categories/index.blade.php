...
{{-- =================================== --}}
  {{-- START INSERT MODEL BOX --}}
      ...
      <div class="container">
        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#addGrade">Add Category</button>
        <!-- Modal -->
                ...
                <div class="modal-body">
                  ...
                  <div class="col-md-12">
                    <div class="tile">
                      ...
                      <div class="tile-body">
                      {{-- INSERT FORM --}}
                        <form class="row" action="{{route('category_add')}}" method="post">
                       @csrf
                          <div class="form-group col-md-6" >
                              <label for="caste_category_name"> Category Name</label>
                                <input type="text" name="caste_category_name" id="caste_category_name" class="form-control" >
                                @error('caste_category_name')
                ...
                <div class="tile-body">
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="sampleTable">
                      ...
                      @php $i=1; @endphp
                      {{-- Foreach Loop start --}}
                      @foreach($castCategory as $data)
                    
                        <tr>
                          <td>{{ $i++}}</td>
                          <td>{{ $data->caste_category_name}}</td>
                                    ...
                                    <div class="col-md-12">
                                      <div class="tile">
                                        ...
                                        {{-- Update FORM --}}
                                          ...
                                          <form class="row" action="{{route('category_update',$data->id)}}" method="post">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-group col-md-6" >
                                              <label for="caste_category_name">Category Name</label>
                                                <input type="text" name="caste_category_name" id="caste_category_name" class="form-control" value="{{$data->caste_category_name}}">
                                                @error('caste_category_name')
                                                  <span class="text-danger" role="alert">
                                                  <strong>{{ $message }}</strong>
                                                </span>
