                 	...
                 	<div class="row" >
                 		@foreach($fee->fees_instalments as $key => $fees_instalment)
							...
							<div class="col-md-4">
								...
								<input type="text" readonly="readonly" class="form-control datepicker" value="{{$fees_instalment->start_dt}}">
							</div>
							<div class="col-md-4">
								<label class="required">Due Date</label>
								<input type="text" readonly="readonly" class="form-control datepicker"  value="{{$fees_instalment->end_dt}}">
							</div>
