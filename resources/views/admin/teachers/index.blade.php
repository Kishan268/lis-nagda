			...
			<div class="panel-body">				
				<div class="row"><br>
					<div class="container">
						...
						<a href="{{route('teachers.create')}}" class="btn btn-md btn-primary pull-right">Create  User
						</a></h4>
						<div class="row">
							<div class="col-md-12">
				...
				<div style="display: none;" class="show_Teacher_table">
	...
	$('#membBtn').on('click',function(e){
		...
		$.ajax({
			...
			success:function(data){
				...
				$('#mainDiv').empty().html(data);
				$('.show_Teacher_table').empty().html(data);
				$('.show_Teacher_table').show(data);
				$('.hide_table').hide();
				$('.show_table').hide();
			}
		});
