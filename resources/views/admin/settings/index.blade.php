  ...
  <div class="container">
   <div class="card shadow mb-4">
      ...
      <div class="card-header py-2 d-flex flex-row align-items-center justify-content-between">
        <h6 style="font-size: 15px;" class="m-0 font-weight-bold text-primary">Settings<h4 class="panel-title">  <a href="{{route('settings.create')}}" class="btn btn-success pull-right btn-sm">Add Settings</a></h4></h6>
      </div>
