...
<div class="container">
       <div class="card shadow mb-4">
          ...
          <div class="card-header py-2 d-flex flex-row align-items-center justify-content-between">
            <h6 style="font-size: 15px;" class="m-0 font-weight-bold text-primary">Create Setting<h4 class="panel-title">  <a href="{{route('settings.create')}}" class="btn btn-success pull-right btn-sm border-radius">Add Setting</a><a href="{{ URL::previous() }}" class="btn btn-info pull-right btn-sm border-radius ">Back</a></h4></h6>
          </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                       ...
                       <input class="form-control input-small " id="title" name="title"  aria-label="Small" type="text" value="{{old('title')}}">
                       @error('title')
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                           <span class="input-group-addon"></span>
                           <input type="emial" class="form-control onlyDigit input-sm" id="email"  name="email"  value="{{old('email')}}" >
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="mobile1">Mobile1</label>
                         <input type="number" name="mobile1" class="form-control " value="{{old('mobile1')}}"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                          @error('mobile1')
                          <span class="text-danger">
                            <strong>{{$message}}</strong>
                          </span>
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="mobile2">Mobile2</label>
                         <input type="number" name="mobile2" class="form-control " value="{{old('mobile2')}}" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                          @error('mobile2')
                          <span class="text-danger">
                            <strong>{{$message}}</strong>
                          </span>
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="tel1">Telephone1</label>
                         <input type="number" name="tel1" class="form-control " value="{{old('tel1')}}"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
                          @error('tel1')
                          <span class="text-danger">
                            <strong>{{$message}}</strong>
                          </span>
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="tel2">Telephone2</label>
                         <input type="number" name="tel2" class="form-control " value="{{old('tel2')}}" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
                          @error('tel2')
                          <span class="text-danger">
                            <strong>{{$message}}</strong>
                          </span>
                    ...
                    <div class="col-md-4">
                         ...
                         <input type="text" name="cbse_aff_no" class="form-control " value="{{old('cbse_aff_no')}}" >
                         @error('cbse_aff_no')
                          <span class="text-danger">
                            <strong>{{$message}}</strong>
                          </span>
                    ...
                    <div class="col-md-4">
                         ...
                         <input type="text" name="mbse_aff_no" class="form-control " value="{{old('mbse_aff_no')}}" >
                         @error('mbse_aff_no')
                          <span class="text-danger">
                            <strong>{{$message}}</strong>
                          </span>
