							  ...
							  <div class="tab-pane fade show active" id="Basic_details" role="tabpanel" aria-labelledby="Basic_details-tab">
								...
								<div class="row form-group">
									<div class="col-md-3 col-xs-6 col-sm-6 error-div">
										...
										<input type="file" name="s_photo" id="s_photo" accept="image/*" ><br>
									...
									<div class="col-md-3 col-xs-6 col-sm-6 error-div">
										...
										<select class="form-control required" name="std_class_id" id="std_class_id">
											<option value="{{$studentsMast->student_class->id}}">{{$studentsMast->student_class->class_name}}</option>
									...
									<div class="col-md-3 col-xs-6 col-sm-6 error-div">
										...
										<select class="form-control required" name="batch_id">
											<option value="{{$studentsMast->student_batch->id}}">{{$studentsMast->student_batch->batch_name}}</option>
									...
									<div class="col-md-3 col-xs-6 col-sm-6 error-div">
										...
										<select class="form-control required" name="section_id" id="section_id">
											<option value="{{$studentsMast->student_section->id}}">{{$studentsMast->student_section->section_name}}</option>
									...
									<div class="col-md-3 col-xs-6 col-sm-6 error-div">
										...
										<input type="text" name="admision_no" value="{{$studentsMast->admision_no}}">
										@error('admision_no')
											<span class="text-danger">
												<strong>{{$message}}</strong>
											</span>
									...
									<div class="col-md-3 col-xs-6 col-sm-6 error-div">
										...
										<input type="text" name="addm_date" class="form-control datepicker required addm_date"  data-date-format="yyyy-mm-dd" placeholder="{{date('Y-m-d')}}" value="{{$studentsMast->addm_date}}">
										@error('addm_date')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="roll_no" class="form-control" value="{{$studentsMast->roll_no}}">
										</div>
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="f_name" id="f_name" class="form-control required" value="{{$studentsMast->f_name}}">
											@error('f_name')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="m_name" id="m_name" class="form-control" value="{{$studentsMast->m_name}}">
											@error('m_name')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="l_name" id="l_name" class="form-control required"  value="{{$studentsMast->l_name}}">
											@error('l_name')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div passout_date" style="display: none;">
											...
											<input type="text" name="passout_date" class="form-control datepicker " readonly="true" data-date-format="yyyy-mm-dd" placeholder="{{date('Y-m-d')}}" value="{{$studentsMast->passout_date}}">
										</div>

										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											<label class="required">Mobile Number</label>
											<input type="text" name="s_mobile" class="form-control required" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" value="{{$studentsMast->s_mobile}}"> 
											@error('s_mobile')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="dob" class="form-control datepicker required" data-date-format="yyyy-mm-dd" placeholder="{{date('Y-m-d')}}" value="{{$studentsMast->dob}}">
											@error('dob')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="birth_place" class="form-control birth_place required" placeholder="" id="birth_place" value="{{$studentsMast->birth_place}}">
											@error('birth_place')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="email" class="form-control required" value="{{$studentsMast->email}}"> 
									...
									<div class="row form-group">
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="spec_ailment" class="form-control" placeholder="Mole on nose. etc" value="{{$studentsMast->spec_ailment}}">
											@error('spec_ailment')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											<label>Age</label>
											<input type="text" name="age" class="form-control age" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" value="{{$studentsMast->age}}">
											@error('age')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
									...
									<div class="row form-group" >
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="taluka" class="form-control" value="{{$studentsMast->taluka}}">
											@error('taluka')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="s_ssmid" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" value="{{$studentsMast->s_ssmid}}">
											@error('s_ssmid')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
										...
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="f_ssmid" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" value="{{$studentsMast->f_ssmid}}">
											@error('f_ssmid')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
									...
									<div class="form-group row">
										<div class="col-md-3 col-sm-6 col-xs-6 error-div">
											...
											<input type="text" name="aadhar_card" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" value="{{$studentsMast->aadhar_card}}">
												@error('f_ssmid')
													<span class="text-danger">
														<strong>{{$message}}</strong>
													</span>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" name="teacher_ward" id="teacher_ward">
                                        <option value="{{$studentsMast->teacher_ward}}">{{$studentsMast->teacher_ward == '1' ? 'Yes' :'No'}}</option>
                                 ...
                                 <div class="col-md-3">
                                  ...
                                  <input class="form-control" id="CBSC_reg" name="cbsc_reg" type="text" value="{{$studentsMast->cbsc_reg}}">
				        		...
				        		<div class="form-group row relation">
				        			<div class="col-sm-6 col-md-4 col-xs-6 error-di">
				        				...
				        				<input type="text" name="prev_school" class="form-control " id="prev_school" value="{{$studentsMast->prev_school}}">
				        				</div>
				        				...
				        				<input type="text" name="year_of_prev_school" class="form-control " id="year_of_prev_school" value="{{$studentsMast->year_of_prev_school}}">
				        					</div>
				        				<div class="col-md-4 col-sm-6 col-xs-6 error-di">
				        					<label class="">Address <strong class="text-danger">*</strong>
				        					</label>
				        					<textarea class="form-control" name="prev_school_address" id="acadmic_address"> {{$studentsMast->prev_school_address}}
				        					</textarea>
				        				</div>
				        				...
				        				<div class="row form-group">
				        					...
				        					<div class="col-md-4 col-xs-6 col-sm-6 error-di">
				        						...
				        						<input type="text" name="acadmic_pin" class="form-control" id="acadmic_pin" value="{{$studentsMast->p_zip_code}}">
				        						</div>
				        					</div>
				        					<div class="form-group row">
				        						...
				        						<div class="col-md-4 col-xs-6 col-sm-6 error-di"><label>Cast</label>
				        							<input type="text" name="acadmic_cast" class="form-control" id="acadmic_cast" value="{{$studentsMast->acadmic_cast_id}}">
				        						</div>
				        						<div class="col-md-4 col-xs-6 col-sm-6 error-di"><label> Attendance Reg. No (In device) </label>
				        							<input type="text" name="acadmic_attendance_reg_no" class="form-control" id="acadmic_attendance_reg_no" value="{{$studentsMast->acadmic_attendance_reg_no}}">
				        						</div>
				        						<div class="col-md-4 col-sm-6 col-xs-6 error-di">
						        					<label class="">Remark <strong class="text-danger">*</strong></label>
						        					<textarea class="form-control" name="acadmic_remark" id="acadmic_remark">{{$studentsMast->acadmic_remark}}</textarea>
						        				</div>
				        							<hr>
				        						</div>
							          <div class="row form-group">
										...
										<div class="panel-body">
											<div class="row form-group">
												...
												<div class="col-md-4 error-di">
													...
													<input type="text" name="p_zip_code" class="form-control" id="p_zip_code" value="{{$studentsMast->p_zip_code}}">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<div class="row form-group">
												...
												<div class="col-md-4 error-di">
													<label class="required">Zip Code</label>
													<input type="text" name="l_zip_code" class="form-control" id="l_zip_code" value="{{$studentsMast->l_zip_code}}">
												</div>
											</div>
										</div>
					        		</div>
								   ...
								   <div class="tab-pane fade" id="bank_details" role="tabpanel" aria-labelledby="bank_details-tab">
						        	...
						        	<div class="row form-group">
						        		<div class="col-md-6 col-sm-6 col-xs-6 error-div">
						        			...
						        			<input type="text" name="bank_name" class="form-control" value="{{$studentsMast->bank_name}}"> 
						        			@error('bank_name')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
						        		...
						        		<div class="col-md-6 col-sm-6 col-xs-6 error-div">
						        			<label>Branch</label>
						        			<input type="text" name="bank_branch" class="form-control" value="{{$studentsMast->bank_branch}}">
						        			@error('bank_branch')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
						        	...
						        	<div class="row form-group">
						        		<div class="col-md-4 col-sm-6 col-xs-6 error-div">
						        			...
						        			<input type="text" name="account_name" class="form-control" value="{{$studentsMast->account_name}}">
						        			@error('account_name')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
						        		...
						        		<div class="col-md-4 col-sm-6 col-xs-6 error-div">
						        			...
						        			<input type="text" name="account_no" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" value="{{$studentsMast->account_no}}">
						        			@error('account_no')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
						        		...
						        		<div class="col-md-4 col-sm-6 col-xs-6 error-div">
						        			...
						        			<input type="text" name="ifsc_code" class="form-control" id="ifsc_code" value="{{$studentsMast->ifsc_code}}">
						        			@error('ifsc_code')
												<span class="text-danger">
													<strong>{{$message}}</strong>
												</span>
                                             ...
                                             <?php $count=1; ?>
	                                             ...
	                                             <tr id="1">
	                                                <td id="sr_no1">{{$count++}}</td>
	                                                  <td> 
	                                                  	<input type="hidden" name="doc_id[]" value="{{ $studenstDoc->id }}" >

	                                                     <input id="doc_title" name="doc_title[]" class="form-control" type="text" placeholder="Enter doc title" value="{{ $studenstDoc->doc_title }}" >
	                                                  ...
	                                                  <td> 
	                                                     <textarea id="doc_description" name="doc_description[]" class="form-control doc_description" placeholder="Enter doc description">{{ $studenstDoc->doc_description }}</textarea> 
	                                                  </td>
	                                                  <td> 
	                                                    <input id="file_name" name="student_doc[]" class="form-control" type="file" placeholder="file" value="{{ $studenstDoc->student_doc }}" >
	                                              ...
	                                              @endforeach
	                                               <td>
	                                                   ...
	                                                   <div class="form-group col-md-12 mt-2" align="left" >
