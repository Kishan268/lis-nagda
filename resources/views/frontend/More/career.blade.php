            ...
            <header class="entry-header">
            	<h1 class="entry-title">Career</h1>	</header><!-- .entry-header -->
            	    <div class="entry-content">
                        ...
                        <form action="/career/#wpcf7-f54-p55-o1" method="post" class="wpcf7-form" enctype="multipart/form-data" novalidate="novalidate">
                    ...
                    <p><label> Apply Post<br />
                        <span class="wpcf7-form-control-wrap menu-923"><select name="menu-923" class="wpcf7-form-control wpcf7-select" aria-invalid="false"><option value="select post">select post</option><option value="PGT English Teacher">PGT English Teacher</option><option value="PGT Social Science Teacher">PGT Social Science Teacher</option><option value="Accounts Teacher">Accounts Teacher</option><option value="Computer Teacher">Computer Teacher</option></select></span> </label>
                    </p>
                    <p><label> Resume<br />
                        <span class="wpcf7-form-control-wrap file-213">
                            <input type="file" name="file-213" size="40" class="wpcf7-form-control wpcf7-file" accept=".pdf,.doc" aria-invalid="false" /></span> </label>
                    </p>
                    ...
                    <div id='widget_tlp_port_owl_carousel-4-port-carousel' class='slider'>
                        <div class='tlp-col-lg-12 tlp-col-md-12 tlp-col-sm-6 tlp-col-xs-12 tlp-equal-height'>
                            ...
                            <div class="tlp-portfolio-thum tlp-item">
                                <img class="img-responsive" src="http://lisnagda.org/wp-content/uploads/2016/11/02222-350x250.jpg" alt="Transport"/>
...
<div class="footer-active-4 footer-widget-area">
    <aside id="text-10" class="widget widget_text">
        ...
        <div class="textwidget"><p><i class="fa fa-facebook"></i>
    ...
    <div class="footer-active-4 footer-widget-area">
        <aside id="nav_menu-5" class="widget widget_nav_menu">
            ...
            <div class="menu-menu2-container"><ul id="menu-menu2" class="menu"><li id="menu-item-1691" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1691"><a href="http://lisnagda.org/">Home</a></li>
...
Copyright. All rights reserved.	     
	      ...
	      <!--<a href=""><!--</a> -->
	      <span class="sep">  </span>
			Developed & maintained By <a href="http://www.libersolution.com/" rel="designer" target="_blank">Liber Solutions Pvt. Ltd.</a>	    
        </div><!-- .site-info -->
	    	</div><!-- .container -->
        </footer><!-- #colophon -->
...
<script type='text/javascript' src='http://lisnagda.org/wp-includes/js/wp-embed.min.js?ver=4.9.16'></script>
...
<script type='text/javascript' src='http://lisnagda.org/wp-content/plugins/tlp-portfolio/assets/vendor/owl.carousel.min.js?ver=4.9.16'></script>
