...
<aside id="widget_tlp_port_owl_carousel-4" class="widget widget_tlp_port_owl_carousel">
        ...
        <div class="tlp-portfolio-item">
            <div class="tlp-portfolio-thum tlp-item">
               ...
               <div class="tlp-overlay">
                <p class="link-icon">
                    <a class="tlp-zoom" href="http://lisnagda.org/wp-content/uploads/2016/11/02222.jpg"><i class="fa fa-search-plus"></i></a>
                    <a target="_blank" href="http://lisnagda.org/portfolio/transport/"><i class="fa fa-external-link"></i></a>
                </p>
              </div>
            </div>
            <div class="tlp-content"><div class="tlp-content-holder"><h3>
                <a href="http://lisnagda.org/portfolio/transport/">Transport</a>
            </h3>
            <p> </p>
        </div>
        </div>
    ...
    <div class='tlp-col-lg-12 tlp-col-md-12 tlp-col-sm-6 tlp-col-xs-12 tlp-equal-height'>
        ...
        <div class="footer-active-4 footer-widget-area">
            <aside id="text-10" class="widget widget_text"><h3 class="widget-title">Social Icons</h3>           
                ...
                </div><!-- .footer-widget-area --><div class="footer-active-4 footer-widget-area"><aside id="text-11" class="widget widget_text"><h3 class="widget-title">About LIS</h3>            <div class="textwidget"><p>Lakshya International school (LIS) Nagda is an  English medium, coeducational, day cum residential school founded in 2015 by the Lakshya Shiksha Avam Unnati Samiti. The school is affiliated to CBSE.<br />
      ...
      <aside id="nav_menu-5" class="widget widget_nav_menu"><h3 class="widget-title">Quick Links</h3>
            <div class="menu-menu2-container">
                  <ul id="menu-menu2" class="menu">
                        ...
                        <li id="menu-item-1692" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1692"><a href="http://lisnagda.org/about-us/">About Us</a>
                        </li>
                        <li id="menu-item-1693" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1693"><a href="http://lisnagda.org/academics/">Academics</a>
                        </li>
